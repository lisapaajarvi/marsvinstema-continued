...
export const mockedProducts: Product[] = [
	{
		...
		url: 'soltalt',
		description:
			'Ett härligt tält med ananasmönster passar perfekt för att söka skydd från solen en varm sommardag. Plats för minst tre marsvin.',
		category: 'leksak',
		price: 459,
	...
	},
	{
		...
		url: 'ho',
		description:
			'Marsvinets bästa vän! Hö är en viktig del av marsvinets diet, och går dessutom utmärkt att gömma sig i och sova under. En bal motsvarar 120 liter prima ängshö.',
		category: 'leksak',
		price: 99,
	...
	},
	{
		...
		url: 'myskorg-kiwi',
		description:
			'Stilfull myskorg i mjukaste fleece, formad som en kiwiskiva. FRUKTansvärt fin!',
		category: 'leksak',
		price: 399,
	...
	},
	{
		...
		url: 'rustning',
		description:
			'Exklusiv handgjord ringbrynja med matchande hjälm. En självklar accessoar till medeltidsveckan!',
		category: 'kläder',
		price: 199999,
	...
	},
	{
		...
		url: 'myskorg',
		description:
			'Vem vill inte sjunka ner i en rosa myskorg dekorerad med fluffiga enhörningar?',
		category: 'leksak',
		price: 299,
	...
	},
	{
		...
		url: 'tomteluva',
		description:
			'Nu är det kallt ute och risk för snuva. Låt ditt marsvin värma sig med denna luva',
		category: 'kläder',
		price: 99,
